    ...
    return (
      <div>
        ...
        <div class="content">        
            ...
            Our vision in creating this space is to empower employees by giving an equitable voice to everyone. At The U, we value what is said over who has said it. Through anonymity and community, we aim to flatten corporate hierarchy and remove professional barriers in order to initiate open conversations and create transparency.
